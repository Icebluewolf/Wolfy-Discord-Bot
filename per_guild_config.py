...
# Command Code Starts Here #
    ...
    if setting_input == "poll":
        ...
        if setting == "module":
            ...
            setting = await get_setting(ctx, "**Type The Role Names You Want To Let Use The Poll.(Separate with `,`)"
                                             " Leave Blank For Everyone.**")
    ...
    if setting_input == "whitelist":
        ...
        if setting == "module":
            ...
            setting = await get_setting(ctx,
                                        "**Type The Role Names You Want To Let Use The Whitelist.(Separate with `,`)"
                                        " Leave Blank For Everyone.**")
